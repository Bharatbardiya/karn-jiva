 ...
 const handleMchat = () => {
  ...
  return (
    <div className="form-container my-3">
      <h1 className='font-weight-bold'>Autism Detection Screening Tool(MChat)</h1>
      <form >
    ...
    <div className="row justify-content-center">
     ...
     <a className='btn btn-primary text-white mt-3 ml-3' style={{width:"100px"}} onClick={()=>(handleMchat())}>Reset</a>
                ...
                <p className="card-text">
                    ...
                    <span className='h3 font-weight-bold mx-2' style={{color: `${apiResult===2 ? "red":(apiResult===1)?"orange" : "green"}`}} >{apiResult=== 0 ? "Not ASD Positive / Low Risk" : (apiResult === 1 ? "Modrate Risk" : "High Risk")}</span> 
                </p>
                <p className="card-text">
                    <span className="font-weight-bold mx-1">Message:</span>
                    <span style={{color: `${apiResult===2 ? "red":(apiResult===1)?"orange" : "green"}`}}>
